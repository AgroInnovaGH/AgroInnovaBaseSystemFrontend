...
export interface BuyingColumn {
  label: string;
  field: string;
}

export const buyingHeaderData: BuyingColumn[] = [
  ...
  { label: 'SubTotal', field: 'product.total' },
  { label: 'Location', field: 'client_location' },
  { label: 'Region', field: 'region' },
  { label: 'Payment', field: 'transaction' },
...
export const tableRows: BuyingRow[] = [
  {
