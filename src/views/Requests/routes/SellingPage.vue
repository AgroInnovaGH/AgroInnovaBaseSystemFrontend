...
import { sellingHeaderData, type SellingColumn } from '../Data/selling_data';
...
const { sellingData } = storeToRefs(store);

const dt = ref();
const numberOfRowsToShow = 10;
const selectedColumns = ref<SellingColumn[]>(sellingHeaderData);

const filters = ref({
  global: { value: null, matchMode: FilterMatchMode.CONTAINS },
});

const onColumnToggle = (val: SellingColumn[]) => {
  selectedColumns.value = sellingHeaderData.filter((col) => val.includes(col));
};
    ...
    <div class="table_card">
      ...
      <div class="datatable_wrapper">
        <DataTable
          ...
          :globalFilterFields="sellingHeaderData.map((col) => col.field)"
        >
          <Column
